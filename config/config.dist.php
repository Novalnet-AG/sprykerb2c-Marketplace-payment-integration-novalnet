...
$config[OmsConstants::PROCESS_LOCATION] = [
    ...
    APPLICATION_ROOT_DIR . '/vendor/novalnet/sprykerb2c-marketplace/config/Zed/Oms',
];
$config[OmsConstants::ACTIVE_PROCESSES] = [
    'NovalnetCreditCard01',
    'NovalnetSepa01',
    'NovalnetSepaGuarantee01',
    'NovalnetInvoice01',
    'NovalnetInvoiceGuarantee01',
...
$config[TranslatorConstants::TRANSLATION_ZED_FILE_PATH_PATTERNS] = [
    APPLICATION_ROOT_DIR . '/vendor/novalnet/sprykerb2c-marketplace/data/translation/Zed/[a-z][a-z]_[A-Z][A-Z].csv',
];
...
$config[NovalnetConstants::NOVALNET] = [
    ...
    NovalnetConstants::NOVALNET_SUB_VENDORS => [
        'MER000001' => [ // Marketplace merchant reference value is mandatory
            'vendor_id' => '', // Your affiliate vendor ID.
            'commission_type' => '', // (percentage/amount) The commission type denoting either fixed amount (in cents) or a percentage that dynamically split the commissions in real time.
            'commission_type_value' => '' // The value which is dynamically split the commissions based on the commission type.
        ]
    ]
];
