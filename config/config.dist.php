...
$config[NovalnetConstants::NOVALNET] = [
    ...
    // ------------------ Novalnet Marketplace Configuration ----------------------
    NovalnetConstants::NOVALNET_MARKETPLACE_CONFIG => [
        'MER000001' => [ // Merchant reference ID from Shop
            'vendor_id' => '', // Affiliate vendor ID from Novalnet
        ],
    ]
];
