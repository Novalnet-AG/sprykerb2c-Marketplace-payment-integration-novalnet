...
interface NovalnetConstants
{
    ...
    public const NOVALNET_SEPA_GUARANTEE_DUE_DATE = 'NOVALNET_SEPA_GUARANTEE_DUE_DATE';
    public const NOVALNET_SEPA_GUARANTEE_MINIMUM_AMOUNT_LIMIT = 'NOVALNET_SEPA_GUARANTEE_MINIMUM_AMOUNT_LIMIT';
    public const NOVALNET_SEPA_GUARANTEE_ONHOLD_AMOUNT_LIMIT = 'NOVALNET_SEPA_GUARANTEE_ONHOLD_AMOUNT_LIMIT';

    public const NOVALNET_INVOICE_GUARANTEE_ONHOLD_AMOUNT_LIMIT = 'NOVALNET_INVOICE_GUARANTEE_ONHOLD_AMOUNT_LIMIT';
    public const NOVALNET_INVOICE_GUARANTEE_MINIMUM_AMOUNT_LIMIT = 'NOVALNET_INVOICE_GUARANTEE_MINIMUM_AMOUNT_LIMIT';

    public const NOVALNET_PREPAYMENT_DUE_DATE = 'NOVALNET_PREPAYMENT_DUE_DATE';
    ...
    public const NOVALNET_MARKETPLACE_CONFIG = 'NOVALNET_MARKETPLACE_CONFIG';
}
